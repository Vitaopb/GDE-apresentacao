...
(function (global) {
  ...
  var ROOMS = [
    ...
    { id: 'quarto-crianca', name: 'Quarto de Criança', category: 'internacao',
      ...
      furnish: { type: 'beds', count: 8, color: 'blue', chairs: true, staff: true, man: 1 } },
    ...
    { id: 'quarto-adolescente', name: 'Quarto de Adolescente', category: 'internacao',
      ...
      furnish: { type: 'beds', count: 6, color: 'green', chairs: true, man: 2 } },
    ...
    { id: 'ban-masculino', name: 'Banheiro Acompanhante Masculino',
      ...
      furnish: { type: 'bathroom', wc: 2, sink: 2, shower: 1, man: 3 } },
